...
class MetadataPanel(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self._search.setToolTip("Filter the metadata of the current image as you type")
        self._search.textChanged.connect(self._on_search_changed)

        self._expand_button = QPushButton("Expand all", self)
        self._expand_button.setToolTip("Expand every metadata group")
        self._expand_button.clicked.connect(self._expand_all)
        self._collapse_button = QPushButton("Collapse all", self)
        self._collapse_button.setToolTip("Collapse every metadata group")
