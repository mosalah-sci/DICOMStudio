...
_SPECS: tuple[ActionSpec, ...] = (
    ...
    ActionSpec(
        ...
        "&Reset View",
        icon="rotate-ccw",
        tooltip="Reset zoom, pan, orientation and window/level (R)",
        status_tip="Reset zoom, pan, orientation and window/level",
    ),
    ActionSpec(
        ActionId.ROTATE_CW,
        "Rotate 90° &Clockwise",
        icon="rotate-cw",
        shortcut="Ctrl+R",
        tooltip="Rotate the image 90 degrees clockwise (Ctrl+R)",
        status_tip="Rotate the image 90 degrees clockwise",
    ),
    ActionSpec(
        ActionId.ROTATE_CCW,
        ...
        tooltip="Rotate the image 90 degrees counter-clockwise (Ctrl+Shift+R)",
        status_tip="Rotate the image 90 degrees counter-clockwise",
    ),
    ActionSpec(
        ...
        shortcut="Ctrl+H",
        tooltip="Mirror the image horizontally (Ctrl+H)",
        status_tip="Mirror the image horizontally",
    ),
    ActionSpec(
        ...
        tooltip="Mirror the image vertically (Ctrl+Shift+H)",
        status_tip="Mirror the image vertically",
    ),
    ActionSpec(
        ActionId.INVERT,
        "&Invert Grayscale",
        icon="invert",
        shortcut="Ctrl+U",
        tooltip="Invert the grayscale display (Ctrl+U)",
        status_tip="Invert the grayscale display",
    ),
    ActionSpec(
        ActionId.PLAY_CINE,
        "&Play Series",
        icon="play",
        shortcut="Space",
        tooltip="Play through the series slices (Space)",
        status_tip="Play through the series slices",
        checkable=True,
        enabled=False,
    ),
    ActionSpec(
    ...
    ActionSpec(
        ...
        "Annotate: &Point",
        icon="target",
        tooltip="Drop a point marker on the image",
        status_tip="Drop a point marker on the image",
        checkable=True,
    ),
    ActionSpec(
        ...
        "Annotate: &Arrow",
        icon="activity",
        tooltip="Draw an annotation arrow (click start and end)",
        status_tip="Draw an annotation arrow (click start and end)",
        checkable=True,
    ),
    ActionSpec(
        ...
        "Annotate: &Text...",
        icon="info",
        tooltip="Place a labelled text note on the image",
        status_tip="Place a labelled text note on the image",
        checkable=True,
    ),
    ActionSpec(
        ActionId.CLEAR_ANNOTATIONS,
        "Clear Anno&tations",
        icon="eraser",
        tooltip="Remove all annotations from every slice",
        status_tip="Remove all annotations from every slice",
        enabled=False,
    ),
    ActionSpec(
        ActionId.TOGGLE_INFO_OVERLAY,
        "&Patient/Study Info",
        tooltip="Show or hide the patient and study information overlay",
        status_tip="Show or hide the patient and study information overlay",
        checkable=True,
    ),
    ActionSpec(
        ...
        "&Manage Presets...",
        icon="sliders",
        tooltip="Create, edit and delete custom window presets",
        status_tip="Manage custom window presets",
    ),
    ActionSpec(
